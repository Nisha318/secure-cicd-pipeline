...
# Custom policy for ECR access with least privilege
...
# ECS Task Role - allows the application to access AWS services
...
# Application-specific permissions (example: if app needs to access S3)
resource "aws_iam_role_policy" "ecs_task_role_policy" {
  ...
  policy = jsonencode({
    ...
    Statement = [
      ...
      # For example: S3, DynamoDB, Secrets Manager access
    ]
  })
}